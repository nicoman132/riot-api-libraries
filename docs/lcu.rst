...
To create a custom game lobby, use the below POST request. Change :code:`PRACTICETOOL` to :code:`CLASSIC` or :code:`TUTORIAL`  if you don't want it to be a practice game.
